  ...
  describe('Abouts Route Tests', function () {
    ...
    describe('Route Config', function () {
      ...
      describe('Create Route', function () {
        ...
        beforeEach(inject(function ($controller, $state, $templateCache) {
          createstate = $state.get('abouts.create');
          $templateCache.put('modules/abouts/client/views/form-about.client.view.html', '');
        ...
        it('should respond to URL', inject(function ($state) {
          expect($state.href(createstate)).toEqual('/abouts/create');
        }));
        ...
        it('Should have templateUrl', function () {
          expect(createstate.templateUrl).toBe('modules/abouts/client/views/form-about.client.view.html');
        });
      });
      ...
      describe('Edit Route', function () {
        ...
        beforeEach(inject(function ($controller, $state, $templateCache) {
          editstate = $state.get('abouts.edit');
          $templateCache.put('modules/abouts/client/views/form-about.client.view.html', '');
        ...
        it('Should have templateUrl', function () {
          expect(editstate.templateUrl).toBe('modules/abouts/client/views/form-about.client.view.html');
        });
